import { Button, Dialog, DialogContent, DialogHeader, Text, Column, styled, Divider } from 'junoblocks';
    ...
    return (
        <Dialog isShowing={isShowing} onRequestClose={onRequestClose}>
            ...
            <DialogContent css={{ paddingBottom: '$12' }}>
                <Column gap={4}>
                    <Button
                        iconLeft={<StyledImgForIcon src="/img/keplr-icon.png" alt="Keplr wallet" />}
                    ...
                    <Button
                        iconLeft={<StyledImgForIcon src="/img/ibc_wallet.png" alt="Cosmostation wallet" />}
